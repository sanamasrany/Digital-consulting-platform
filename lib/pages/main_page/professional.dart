...
class VocationalPage  extends StatelessWidget{
            ...
            child: Container(
                ...
                child: Obx (() {
                  ...
                  return ListView.builder(
                      ...
                      itemCount: controller.expertsListvocational.length,

                      itemBuilder: (context, i) {
                        VocationalElement ex = controller.expertsListvocational[i];
                        return
                          Card(
                              elevation: 5.2,
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                      ...
                                      Container(
                                        ...
                                        // color: Colors.amber,
                                        child:
                                        controller.expertsListvocational[i].expert.imgpath !=null
                                            ? CircleAvatar(
                                          backgroundImage:

                                          NetworkImage('${ServerConfig.domainNameserver}/${controller.expertsListvocational[i].expert.imgpath}'
                                        ...
                                        Expanded(child: Column(
                                            ...
                                            children: [
                                              Expanded(child: Text(
                                                  controller.expertsListvocational[i].expert.name
                                              ...
                                              Expanded(child: Text(
                                                  controller.expertsListvocational[i]
                                                      .expert.experinces
                                                  ,
                                                  style: TextStyle(
                                                    color: Colors.black,
