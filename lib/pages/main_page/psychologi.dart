            ...
            child: Container(
                ...
                child: Obx (() {
                  ...
                  return ListView.builder(
                      ...
                      itemCount: controller.expertsListpsychological.length,

                      itemBuilder: (context, i) {
                        PsychologicalElement ex = controller.expertsListpsychological[i];
                        return
                          Card(
                              elevation: 5.2,
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                      ...
                                      Container(
                                        ...
                                        // color: Colors.amber,
                                        child:
                                        controller.expertsListpsychological[i].expert.imgpath !=null
                                            ? CircleAvatar(
                                          backgroundImage:

                                          NetworkImage('${ServerConfig.domainNameserver}/${controller.expertsListpsychological[i].expert.imgpath}'
                                        ...
                                        Expanded(child: Column(
                                            ...
                                            children: [
                                              Expanded(child: Text(
                                                  controller.expertsListpsychological[i].expert.name
                                              ...
                                              Expanded(child: Text(
                                                  controller.expertsListpsychological[i]
                                                      .expert.experinces
                                                  ,
                                                  style: TextStyle(
                                                    color: Colors.black,
