            ...
            child: Container(
                ...
                child: Obx (() {
                  ...
                  return ListView.builder(
                      ...
                      itemCount: controller.expertsListbusiness.length,

                      itemBuilder: (context, i) {
                        BusinessElement ex = controller.expertsListbusiness[i];
                        return
                          Card(
                              elevation: 5.2,
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                      ...
                                      Container(
                                        ...
                                        // color: Colors.amber,
                                        child:
                                        controller.expertsListbusiness[i].expert.imgpath !=null
                                            ? CircleAvatar(
                                          backgroundImage:

                                          NetworkImage('${ServerConfig.domainNameserver}/${controller.expertsListbusiness[i].expert.imgpath}'
                                        ...
                                        Expanded(child: Column(
                                            ...
                                            children: [
                                              Expanded(child: Text(
                                                  controller.expertsListbusiness[i].expert.name
                                              ...
                                              Expanded(child: Text(
                                                  controller.expertsListbusiness[i]
                                                      .expert.experinces
                                                  ,
                                                  style: TextStyle(
                                                    color: Colors.black,
