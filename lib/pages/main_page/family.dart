            ...
            child: Container(
                ...
                child: Obx (() {
                  ...
                  return ListView.builder(
                      ...
                      itemCount: controller.expertsListfamily.length,

                      itemBuilder: (context, i) {
                        FamilyElement ex = controller.expertsListfamily[i];
                        return
                          Card(
                              elevation: 5.2,
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                      ...
                                      Container(
                                        ...
                                        // color: Colors.amber,
                                        child:
                                        controller.expertsListfamily[i].expert.imgpath !=null
                                            ? CircleAvatar(
                                          backgroundImage:

                                          NetworkImage('${ServerConfig.domainNameserver}/${controller.expertsListfamily[i].expert.imgpath}'
                                        ...
                                        Expanded(child: Column(
                                            ...
                                            children: [
                                              Expanded(child: Text(
                                                  controller.expertsListfamily[i].expert.name
                                              ...
                                              Expanded(child: Text(
                                                  controller.expertsListfamily[i]
                                                      .expert.experinces
                                                  ,
                                                  style: TextStyle(
                                                    color: Colors.black,
