...
class Family {
  ...
  List<FamilyElement> family;

  factory Family.fromJson(Map<String, dynamic> json) => Family(
    family: List<FamilyElement>.from(json["Family"].map((x) => FamilyElement.fromJson(x))),
  );
...
class FamilyElement {
  FamilyElement({
    ...
    required this.timeOfConsultaionF,
    required this.costF,
  ...
  int expertId;
  int consultationId;
  int timeOfConsultaionF;
  int costF;
  DateTime createdAt;
  DateTime updatedAt;
  ExpertF expert;

  factory FamilyElement.fromJson(Map<String, dynamic> json) => FamilyElement(
    id: json["id"],
    expertId: json["expert_id"],
    consultationId: json["consultation_id"],
    timeOfConsultaionF: json["time_of_consultaion_f"],
    costF: json["cost_f"],
    createdAt: DateTime.parse(json["created_at"]),
    updatedAt: DateTime.parse(json["updated_at"]),
    expert: ExpertF.fromJson(json["expert"]),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "time_of_consultaion_f": timeOfConsultaionF,
    "cost_f": costF,
...
class ExpertF {
  ...
  factory ExpertF.fromJson(Map<String, dynamic> json) => ExpertF(
    id: json["id"],
    name: json["name"],
    email: json["email"],
